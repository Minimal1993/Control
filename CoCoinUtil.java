...
import com.nightonke.saver.*;
import com.nightonke.saver.activity.CoCoinApplication;
import com.nightonke.saver.db.*;
...
public class CoCoinUtil {
    ...
    public static CoCoinRecord backupCoCoinRecord = new CoCoinRecord();
    public static String psw = "1234";
    public static int[] WEEKDAY_SHORT_START_ON_MONDAY = {
            0,
            R.string.monday_short, R.string.tuesday_short, R.string.wednesday_short, R.string.thursday_short, R.string.friday_short, R.string.saturday_short, R.string.sunday_short
    };
    public static int[] WEEKDAY_SHORT_START_ON_SUNDAY = {
            0, R.string.sunday_short, R.string.monday_short, R.string.tuesday_short, R.string.wednesday_short, R.string.thursday_short, R.string.friday_short, R.string.saturday_short
    };
    public static int[] WEEKDAY_START_ON_MONDAY = {
            0, R.string.monday, R.string.tuesday, R.string.wednesday, R.string.thursday, R.string.friday, R.string.saturday, R.string.sunday
    };
    public static int[] WEEKDAY_START_ON_SUNDAY = {
            0, R.string.sunday, R.string.monday, R.string.tuesday, R.string.wednesday, R.string.thursday, R.string.friday, R.string.saturday
    };
    public static String[] FLOATINGLABELS = {
            "", "", "十", "百", "千", "万", "十万", "百万", "千万", "亿", "十亿"
    };
    public static String[] BUTTONS = {
            "1", "2", "3", "4", "5", "6", "7", "8", "9", "D", "0", "Y"
    };
    public static int[] TODAY_VIEW_EMPTY_TIP = {
            R.string.today_empty, R.string.yesterday_empty, R.string.this_week_empty, R.string.last_week_empty, R.string.this_month_empty, R.string.last_month_empty, R.string.this_year_empty, R.string.last_year_empty
    };
    ...
    public static int[] MONTHS = {
            0, R.string.january, R.string.february, R.string.march, R.string.april, R.string.may, R.string.june, R.string.july, R.string.august, R.string.september, R.string.october, R.string.november, R.string.december
    };
    public static int TODAY_VIEW_TITLE[] = {
            R.string.today_view_today, R.string.today_view_yesterday, R.string.today_view_this_week, R.string.today_view_last_week, R.string.today_view_this_month, R.string.today_view_last_month, R.string.today_view_this_year, R.string.today_view_last_year
    };
    ...
    public static Typeface typefaceLatoRegular = (Typeface) new Object();
    public static Typeface typefaceLatoHairline = (Typeface) new Object();
    public static Typeface typefaceLatoLight = (Typeface) new Object();
    ...
    public static RelativeSizeSpan relativeSizeSpan = (RelativeSizeSpan) new Object();
    public static ForegroundColorSpan redForegroundSpan = (ForegroundColorSpan) new Object();
    public static ForegroundColorSpan greenForegroundSpan = (ForegroundColorSpan) new Object();
    public static ForegroundColorSpan whiteForegroundSpan= (ForegroundColorSpan) new Object();
    ...
    public static String GetCalendarStringRecordCheckDialog(Context context, Calendar calendar) {
        ...
        if ("zh".equals(Locale.getDefault().getLanguage())) {
            return context.getResources().getString(MONTHS_SHORT[calendar.get(Calendar.MONTH) + 1]) + calendar.get(Calendar.DAY_OF_MONTH) + CoCoinUtilMethods1.GetWhetherFuck() + " " + calendar.get(Calendar.YEAR);
        }
        return context.getResources().getString(MONTHS_SHORT[calendar.get(Calendar.MONTH) + 1]) + " " + calendar.get(Calendar.DAY_OF_MONTH) + " " + calendar.get(Calendar.YEAR);
    }
    public static String GetCalendarStringDayExpenseSort(Context context, int year, int month, int day) {
        ...
        if ("zh".equals(Locale.getDefault().getLanguage())) {
            return context.getResources().getString(MONTHS_SHORT[month]) + day + CoCoinUtilMethods1.GetWhetherFuck() + " " + year;
        }
        return context.getResources().getString(MONTHS_SHORT[month]) + " " + day + " " + year;
    }
    ...
    public static int GetRandomColor() {
        ...
        int p = random.nextInt(CoCoinUtil.Colors.length);
        while (CoCoinUtil.Colors[p].equals(CoCoinUtil.lastColor0)
                || CoCoinUtil.Colors[p].equals(CoCoinUtil.lastColor1)
                || CoCoinUtil.Colors[p].equals(CoCoinUtil.lastColor2)) {
            p = random.nextInt(CoCoinUtil.Colors.length);
        }
        CoCoinUtil.lastColor0 = CoCoinUtil.lastColor1;
        CoCoinUtil.lastColor1 = CoCoinUtil.lastColor2;
        CoCoinUtil.lastColor2 = CoCoinUtil.Colors[p];
        return Color.parseColor(CoCoinUtil.Colors[p]);
    }

    public static void clearState(Drawable drawable) {
        if (drawable != null) {
            drawable.setState(CoCoinUtil.EMPTY_STATE);
        }
    }
}
