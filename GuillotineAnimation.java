...
//questo import non può essere cancellato anche se Kiuwan dice che è inutilizzato
...
public class GuillotineAnimation {
    ...
    public static class GuillotineBuilder {
        ...
        public GuillotineBuilder setGuillotineListener(GuillotineListener var) {
            this.guillotineListener = var;
            return this;
        }

        public GuillotineBuilder setDuration(long dur1) {
            this.duration = dur1;
            return this;
        }

        public GuillotineBuilder setStartDelay(long start1) {
            this.startDelay = start1;
            return this;
        }

        public GuillotineBuilder setRightToLeftLayout(boolean fun2) {
            this.isRightToLeftLayout = fun2;
            return this;
        }

        public GuillotineBuilder setInterpolator(TimeInterpolator inter1) {
            this.interpolator = inter1;
            return this;
        }

        public GuillotineBuilder setClosedOnStart(boolean is1) {
            this.isClosedOnStart = is1;
            return this;
        }
